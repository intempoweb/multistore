<footer class="ciak-footer teknikoshop-footer">
    @php
    ...
    @endphp
    <div class="ciak-service-row ciak-shell teknikoshop-service-row">
        ...
        <a href="{{ $serviceCookieUrl }}"><i data-lucide="shield-check"></i><span><strong>{{ __('themes_b2c.ciak.protected_purchases') }}</strong><small>{{ __('themes_b2c.ciak.secure_checkout') }}</small></span></a>
        <a href="{{ $serviceStoreLocatorUrl }}"><i data-lucide="map-pin"></i><span><strong>Store locator</strong><small>Trova un rivenditore</small></span></a>
        <a href="{{ $serviceAccountUrl }}"><i data-lucide="user-round"></i><span><strong>{{ __('themes_b2c.ciak.personal_area') }}</strong><small>{{ __('themes_b2c.ciak.orders_and_favorites') }}</small></span></a>
    </div>
    <div class="ciak-footer-main ciak-shell">
        ...
        <div class="ciak-footer-brand">
            <a href="{{ route('storefront.home', $contextParams ?? []) }}" class="ciak-footer-brand-link teknikoshop-footer-brand-link" aria-label="{{ $publicStoreName }}">
