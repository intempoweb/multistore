...
@php
    $pageTitle = __('themes_b2c.intempo.about_us');
    $pageLead = 'Lo stile italiano sempre attuale pensato per conquistare il gusto di tutti, in qualsiasi parte del mondo.';
    $aboutSections = [
        [
