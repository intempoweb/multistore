...
>
    @include('storefront.themes.b2c.ready.partials.header', ['contextParams' => $contextParams, 'agentContextId' => $agentContextId])

    <main class="intempo-b2c-main storefront-main ready-main">
