...
@php
    ...
    $customerCode = $customer->clifor_cg44
        ?: $customer->codice_cg16
        ?: '-';

    $customerVat = trim(
        (string) ($customer->partiva_cg16 ?? '')
    );

    $paymentCode = trim(
        (string) ($customer->codpag_cg62 ?? '')
    );
        ...
        <section class="border rounded-3 bg-white p-4 p-lg-5">
            <div class="d-flex flex-column flex-xl-row justify-content-between gap-4">
                <div class="flex-grow-1">
                    ...
                    <div class="text-uppercase small fw-bold text-primary mb-2">
                        Area documentale
                    </div>
                    ...
                    <p class="text-muted mb-0">
                        Consulta documenti ERP, DDT, fatture e ordini
                        collegati alla tua anagrafica.
                    </p>
                </div>
                        ...
                        <div>
                            ...
                            <div class="fw-semibold text-break">
                                @if($customer->indeemail_vwebdcg44)
                                    <a
                                        href="mailto:{{ $customer->indeemail_vwebdcg44 }}"
            ...
            <div class="d-flex flex-column flex-lg-row justify-content-between gap-3 mb-4">
                <div>
                    ...
                    <div class="text-muted small">
                        Cerca per numero, tipo documento o intervallo date.
                    </div>
                </div>
        ...
        <section class="border rounded-3 bg-white overflow-hidden">
            <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 p-4 border-bottom">
                <div>
                    ...
                    <div class="text-muted small">
                        Storico ERP disponibile per il cliente selezionato.
                    </div>
                </div>
                        ...
                        @if($documents->count() === 0)
                            <tr>
                                ...
                                >
                                    ...
                                    <div class="text-muted small">
                                        Modifica i filtri o riprova più tardi.
                                    </div>
                                </td>
                            </tr>
                        @else
