...
class CustomerSyncService
{
    ...
    private function fetchChangedCustomersFromErp(array $ditte, string $sinceDate, ?int $limit): array
    {
        ...
        $remoteSql = "
            SELECT {$top}
                VWEBCG16_DITTA_CG18 AS DITTA_CG18,
                VWEBCG16_TIPOCF_CG44 AS TIPOCF_CG44,
                VWEBCG16_CLIFOR_CG44 AS CLIFOR_CG44,
                VWEBCG16_CODICE_CG16 AS CODICE_CG16,
                VWEBCG16_RAGSOANAG_CG16 AS RAGSOANAG_CG16,
                VWEBCG16_PARTIVA_CG16 AS PARTIVA_CG16,
                VWEBCG16_CODFISCALE_CG16 AS CODFISCALE_CG16,
                VWEBCG16_COGNOMECONNWEB AS COGNOMECONNWEB,
                VWEBCG16_NOMECONNWEB AS NOMECONNWEB,
                VWEBCG16_INDEMAIL_CG16 AS INDEMAIL_CG16,
                VWEBCG16_INDEMAILPERFATT_CG16 AS INDEMAILPERFATT_CG16,
                VWEBCG16_TEL1NUM_CG16 AS TEL1NUM_CG16,
                VWEBCG16_TEL2NUM_CG16 AS TEL2NUM_CG16,
                VWEBCG16_FAXNUM_CG16 AS FAXNUM_CG16,
                VWEBCG16_CELLNUM_CG16 AS CELLNUM_CG16,
                VWEBCG16_INDWEB_CG16 AS INDWEB_CG16,
                VWEBCG16_EMAIL_PEC_CG16 AS EMAIL_PEC_CG16,
                VWEBCG16_INDIRIZZO_CG16 AS INDIRIZZO_CG16,
                VWEBCG16_CAP_CG16 AS CAP_CG16,
                VWEBCG16_CITTA_CG16 AS CITTA_CG16,
                VWEBCG16_PROV_CG16 AS PROV_CG16,
                VWEBCG16_RAGSOCOR_CG16 AS RAGSOCOR_CG16,
                VWEBCG16_INDIRCOR_CG16 AS INDIRCOR_CG16,
                VWEBCG16_CAPCOR_CG16 AS CAPCOR_CG16,
                VWEBCG16_CITTACOR_CG16 AS CITTACOR_CG16,
                VWEBCG16_PROVCOR_CG16 AS PROVCOR_CG16,
                VWEBCG16_CODPAG_CG62 AS CODPAG_CG62,
                VWEBCG16_DESCRIZPAG_CG62 AS DESCRIZPAG_CG62,
                VWEBCG16_AGENTE_MG17 AS AGENTE_MG17,
                VWEBCG16_RAGSOANAG_VWEBDCG44 AS RAGSOANAG_VWEBDCG44,
                VWEBCG16_INDEMAIL_VWEBDCG44 AS INDEMAIL_VWEBDCG44,
                VWEBCG16_CODICE_CG28 AS CODICE_CG28,
                VWEBCG16_DESCR_CG28 AS DESCR_CG28,
                VWEBCG16_PERCIVA_CG28 AS PERCIVA_CG28,
                VWEBCG16_CODLISTINODED AS CODLISTINODED,
                VWEBCG16_CODRIFALF_MG19 AS CODRIFALF_MG19,
                VWEBCG16_CCABI_MG35 AS CCABI_MG35,
                VWEBCG16_CCCAB_MG35 AS CCCAB_MG35,
                VWEBCG16_DESBANCA_CG12_CG13 AS DESBANCA_CG12_CG13,
                VWEBCG16_IBAN_MG35 AS IBAN_MG35,
