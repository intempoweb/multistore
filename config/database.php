...
return [
    ...
    'connections' => [
        ...
        'erp' => [
            'driver' => env('ERP_DB_CONNECTION', 'sqlsrv'),
            ...
            // Driver reale: PDO dblib / FreeTDS.
            // Questo valore viene usato da Laravel nel DSN dblib.
            'timeout' => (int) env('ERP_DB_QUERY_TIMEOUT', 300),
        ],
